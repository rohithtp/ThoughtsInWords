...
A personal repository for organizing and archiving written thoughts, reflections, and articles.

## Purpose

ThoughtsInWords is a structured space for capturing daily thoughts, ideas, articles, and reflections.

## Organization

Articles are organized by **topic** (tags) rather than chronologically. This aligns with a "digital garden" approach where content is grouped by context.
...
2. Create a new markdown file: `my-topic.md`.
3. Link it in the index below.
...
- [ai/how-to-connect-google-stitch.md](ai/how-to-connect-google-stitch.md) - How to Connect Google Stitch to Your Workflow: A Step-by-Step Guide
...
- [2026/01/26/human_in_the_loop.md](2026/01/26/human_in_the_loop.md) - Overview of Human in the Loop (HITL) AI
...
- [cloud-native/sandbox-ephemeral-identity-primitive.md](cloud-native/sandbox-ephemeral-identity-primitive.md) - Sandbox and Ephemeral Identity Primitives
...
- [devops/replacing-on-call-with-clopus-watcher.md](devops/replacing-on-call-with-clopus-watcher.md) - Replacing the On-Call Engineer with Clopus-Watcher
- [devops/telemetry-capturing-the-usage.md](devops/telemetry-capturing-the-usage.md) - Telemetry: Capturing the Usage

#### Platform & Scaling

- [2026/01/23/vclusters-evolution-and-changes.md](2026/01/23/vclusters-evolution-and-changes.md) - Evolution and changes in Kubernetes vClusters (2024-2026)
...
- [2026/01/26/irctc_prediction_apps_2026.md](2026/01/26/irctc_prediction_apps_2026.md) - Top IRCTC Ticket Prediction Apps & Features in 2026
